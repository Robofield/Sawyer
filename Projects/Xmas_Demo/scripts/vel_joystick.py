...
#@todo: 
    # configure this node to use moveit servoing instead of using direct velocity control calculated manually
    # add a button to switch between velocity control and position control
